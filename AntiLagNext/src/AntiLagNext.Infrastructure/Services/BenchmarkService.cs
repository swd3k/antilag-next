        ...
        try
        {
            ...
            if (max > 500 || p99 > 200)
            {
                ...
                summary =
                    ...
                    "High Performance + все ядра активны уменьшает «просадки» при всплесках нагрузки. " +
            ...
            else if (median < 50 && max < 150)
            {
                ...
                summary =
                    ...
                    "Достаточно **офисного профиля**: таймер 1.0 мс, мягкий режим ядер (E-cores не трогаем). " +
